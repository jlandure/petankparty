...
public class ChartResource extends PlayerResource {
	...
	def toHTML(html, writer) {
		...
		String gString = """<img src="http://chart.apis.google.com/chart?chs=500x200&amp;cht=lc&amp;chds=0,400&amp;chxt=y&amp;chxl=0:|50|100|150|200|250|300|350|400&amp;chxp=0,50,100,150,200,250,300,350,400|&amp;chtt=${player.name}&amp;chd=t:${allpoints}" alt="Chart ${player.name}" />"""		
	}
